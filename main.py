...
label_timer = Label(text='Timer', font=(FONT_NAME, 24, 'normal'), bg=YELLOW, fg=GREEN)
label_timer.grid(column=1, row=0)

button_start = Button(text='Start', font=(FONT_NAME, 10, 'normal'))
button_start.grid(column=0, row=2)

button_reset = Button(text='Reset', font=(FONT_NAME, 10, 'normal'))
button_reset.grid(column=2, row=2)

pomodoro_counter = Label(text='✓', font=(FONT_NAME, 12, 'normal'), bg=YELLOW, fg=GREEN)
